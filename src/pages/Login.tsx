        ...
        >
          ...
          {error && (
            <motion.div
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
              className="px-4 py-3 rounded-lg bg-destructive/10 border border-destructive/30 flex items-start gap-2 mb-4"
            >
          ...
          >
            ...
            <span className="text-[10px] text-muted-foreground/60 font-display uppercase tracking-widest">or</span>
            <div className="flex-1 h-px bg-border/40" />
          </motion.div>
          ...
          >
            Sign in to save scores, streaks & compete on leaderboard
          </motion.p>
        </motion.div>
      </div>
    </div>
