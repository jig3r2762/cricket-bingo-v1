...
export default function HowToPlay() {
  useSeoHead({
    title: "How to Play Cricket Bingo â€” Rules, Scoring & Strategy Guide",
    description:
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <section className="mb-10">
          ...
          <p className="text-muted-foreground font-body text-sm leading-relaxed mb-3">
            ...
            with a grid (3x3 or 4x4) where each cell represents a cricket category â€” like an
          ...
          <p className="text-muted-foreground font-body text-sm leading-relaxed">
            The goal is to complete a full row, column, or diagonal â€” just like bingo. Every day
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground font-body text-sm leading-relaxed">
                    ...
                    to help you â€” cells the player qualifies for glow cyan, while non-matching cells are dimmed.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <ul className="text-muted-foreground font-body text-sm leading-relaxed space-y-1 ml-4">
                    ...
                    <li><strong>Wildcard:</strong> Place any player on any empty cell with no validation. You get one wildcard per game â€” save it for combo cells that are hard to fill.</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-3">
            {[
              { icon: "ðŸ", name: "IPL Team", desc: "The player must have played for this IPL franchise at any point in their career. Past teams count â€” if someone played for MI in 2015, the MI cell still accepts them.", example: "MI, CSK, RCB, KKR, DC, SRH, RR, PBKS, GT, LSG" },
              { icon: "ðŸŒ", name: "Country", desc: "The player's international team. A player representing India in any format qualifies for the India cell.", example: "India, Australia, England, Pakistan, South Africa, New Zealand" },
              { icon: "âš¾", name: "Player Role", desc: "The player's primary playing role. Wicket-keeper batsmen qualify for both 'WK' and 'Batsman' cells.", example: "Batsman, Fast Bowler, Spin Bowler, All-Rounder, Wicket-Keeper" },
              { icon: "ðŸ“Š", name: "Career Stats", desc: "Statistical milestones across the player's career. Stats are aggregated across all formats unless specified.", example: "10,000+ runs, 300+ wickets, 50+ Test matches, Century Maker" },
              { icon: "ðŸ†", name: "Trophy", desc: "Tournaments the player has won. The player must have been part of the winning squad.", example: "IPL Winner, Cricket World Cup, T20 World Cup, Champions Trophy" },
              { icon: "ðŸ¤", name: "Teammate", desc: "The drawn player must have appeared in the same playing XI as the named player in an official match.", example: "Played with Dhoni, Played with Kohli, Played with Sachin" },
              { icon: "ðŸ”€", name: "Combo", desc: "Two criteria combined â€” both must be true simultaneously. These are the hardest cells to fill because fewer players qualify. Prioritize placing players here.", example: "MI + India, Australia + Fast Bowler, CSK + IPL Winner" },
            ].map((cat) => (
        ...
        <section className="mb-10">
          ...
          <div className="space-y-3">
            {[
              ...
              { title: "Think about IPL history", tip: "Many players have played for multiple IPL teams across seasons. A player who's currently at GT might have played for MI, RCB, or CSK in earlier seasons â€” all those teams count." },
              ...
              { title: "Watch the recommended cell", tip: "The game highlights the optimal cell for each player with a gold border. This is the hardest-to-fill cell the player matches â€” usually the best strategic choice." },
            ].map((item) => (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="candy-card p-5">
              ...
              <p className="text-muted-foreground font-body text-sm leading-relaxed">
                ...
                clues for more points. Tests your deep cricket knowledge â€” can you name them from
                just their stats?
              </p>
            </div>
            <div className="candy-card p-5">
              ...
              <p className="text-muted-foreground font-body text-sm leading-relaxed">
                ...
                Same grid, same deck â€” the player who scores higher wins. Real-time gameplay.
              </p>
            </div>
            <div className="candy-card p-5">
              ...
              <p className="text-muted-foreground font-body text-sm leading-relaxed">
                ...
                opponent â€” winner takes the pot. For serious cricket quiz champions.
              </p>
            </div>
          </div>
        </section>
