      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <section className="text-center py-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link to="/how-to-play" className="px-8 py-3.5 rounded-2xl border-2 border-gray-300 text-foreground font-body font-bold text-sm bg-white hover:border-gray-400 transition-all inline-block"
